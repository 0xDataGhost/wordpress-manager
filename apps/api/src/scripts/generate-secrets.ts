...
const lines = [
  ...
  "# HMAC-SHA256 secret for customer self-service tokens (Phase 22). MUST be",
  "# distinct from DIGITAL_CODE_HASH_KEY. Rotating it invalidates all live links.",
  `CUSTOMER_TOKEN_HASH_KEY=${strongHex()}`,
